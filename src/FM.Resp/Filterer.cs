        ...
        public async Task<int> Run()
        {
            ...
            if (Options.Format == FileFormat.Json)
            {
                ...
                if (Options.FromIndex != null)
                {
                    ...
                    Console.WriteLine($" done. ({removeCount} element(s) removed.)");
                }
                ...
                var json = JsonConvert.SerializeObject(elements.ToArray(), Options.Indented ? Formatting.Indented : Formatting.None);
                Console.WriteLine(" done.");
